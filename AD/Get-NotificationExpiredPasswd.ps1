...
[CmdletBinding()]Param (
    ...
    ,[Parameter(Mandatory=$False,Position=2)] [Alias("SMTPServer")] [String]$attrSMTP = 'smtp.test.cz'
    ,[Parameter(Mandatory=$False,Position=3)] [Alias("FromAddress")] [String]$attrFromAddress = 'weis@test.cz'
