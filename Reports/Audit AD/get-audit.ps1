...
Function Get-WindowsUpToDate {
    ...
    # Zjištení zda jsou aktualizace rízené z WSUS nebo prímo z MS serveru
...
Function Get-FirewallStatus {
    ...
    # Kontrola, zda je firewall rízen pomocí GPO
...
"@
    ...
    # Pridání stavu SMB1 do HTML reportu
...
"@
    ...
    # Pridání stavu služby Spooler do HTML reportu
